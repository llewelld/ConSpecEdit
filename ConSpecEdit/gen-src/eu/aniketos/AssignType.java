...
@XmlType(name = "assignType", propOrder = {
    "identifier",
    "value"
})
public class AssignType {
    ...
    @XmlElement(required = true)
    protected AssignType.Value value;
     ...
     * @return
     *     possible object is
     *     {@link AssignType.Value }
     *     
     */
    public AssignType.Value getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(AssignType.Value value) {
        this.value = value;
    }
